...
export const modelNames: { [key in Model]: [string, string] } = {
  ...
  "anthropic-claude-opus": ["Opus", "Anthropic Claude Opus"],
  "anthropic-claude-haiku": ["Haiku", "Anthropic Claude Haiku"],
  "anthropic-claude-sonnet": ["Sonnet", "Anthropic Claude Sonnet"],
  "perplexity-sonar-small-online": ["Sonar", "Perplexity Sonar Small"],
  "perplexity-sonar-medium-online": ["Sonar", "Perplexity Sonar Medium"],
  "groq-mixtral-8x7b-32768": ["Mixtral", "Mixtral 8x7b"],
  "perplexity-codellama-70b-instruct": [
    "Code Llama 70b",
    "Meta Code Llama 70b",
  ],
