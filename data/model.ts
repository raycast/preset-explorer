...
export const modelNames: { [key in Model]: [string, string] } = {
  ...
  "anthropic-claude-opus": ["Opus", "Antrophic Claude Opus"],
  "anthropic-claude-haiku": ["Haiku", "Antrophic Claude Haiku"],
  "anthropic-claude-sonnet": ["Sonnet", "Antrophic Claude Sonnet"],
